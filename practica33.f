	...
	END SUBROUTINE EntradaBilletes
	
	SUBROUTINE ValorCompra

	PRINT*, "Introduzca el valor de su compra"
	READ*, compra
	
	END SUBROUTINE ValorCompra
	
	SUBROUTINE SalidaCambio
	INTEGER :: a,b,c,d,e,f
	INTEGER :: g,h,i,j,k,l
